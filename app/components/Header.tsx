...
export default function Header() {
  ...
  const getLinkClasses = (href: string) => {
    const baseClasses =
      "px-5 py-3 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105";
    const activeClasses =
      "text-white bg-gradient-to-r from-blue-500 to-blue-600 shadow-lg border-b-2 border-blue-700";
    const inactiveClasses =
      "text-gray-700 hover:text-blue-900 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100 hover:shadow-md";
  ...
  const getMobileLinkClasses = (href: string) => {
    const baseClasses =
      "block px-6 py-4 rounded-xl font-semibold transition-all duration-300 transform hover:scale-105";
    const activeClasses =
      "text-white bg-gradient-to-r from-blue-500 to-blue-600 shadow-lg border-l-4 border-blue-700";
    const inactiveClasses =
      "text-gray-700 hover:text-blue-900 hover:bg-gradient-to-r hover:from-blue-50 hover:to-blue-100";
  ...
  return (
    <>
      {/* Top Bar - Fixed */}
      <div
        className={`bg-gradient-to-r from-blue-900 via-blue-800 to-indigo-900 text-white py-3 hidden md:block fixed top-0 left-0 right-0 z-50 transition-all duration-500 backdrop-blur-sm ${
      ...
      {/* Main Header */}
      <header
        className={`bg-gradient-to-r from-white via-blue-50 to-white shadow-2xl sticky z-40 border-b-4 border-blue-500 transition-all duration-500 backdrop-blur-lg ${
          isScrolled ? "top-0 bg-opacity-95" : "top-12"
        }`}
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="flex items-center justify-between py-6">
            ...
            <nav className="hidden lg:flex items-center space-x-2">
              <Link
                href="/presentation"
                className={getLinkClasses("/presentation")}
              >
                À Propos
              </Link>
                ...
                <div className="absolute top-full left-0 mt-2 w-80 bg-gradient-to-br from-white via-blue-50 to-white rounded-2xl shadow-2xl border-2 border-blue-200 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 transform translate-y-2 group-hover:translate-y-0 backdrop-blur-sm">
                  <div className="p-6">
                    <div className="space-y-2">
                      <Link
                        href="/formations"
                        className="block px-4 py-3 text-gray-700 hover:text-blue-900 hover:bg-gradient-to-r hover:from-blue-100 hover:to-blue-200 rounded-xl font-medium transition-all duration-300 transform hover:scale-105"
                      >
              ...
              <Link
                href="/vie-etudiante"
                className={getLinkClasses("/vie-etudiante")}
              >
                Vie Étudiante
              </Link>
              <Link
                href="/partenariats"
                className={getLinkClasses("/partenariats")}
              >
                Partenariats
              </Link>
          ...
          {isMenuOpen && (
            <div className="lg:hidden border-t-2 border-blue-200 bg-gradient-to-br from-blue-50 via-white to-blue-50 backdrop-blur-lg">
              <nav className="py-6 space-y-3 px-4">
                ...
                <Link
                  href="/admission"
                  className="block mx-2 mt-6 bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white px-8 py-4 rounded-2xl font-bold text-center shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300"
                  onClick={() => setIsMenuOpen(false)}
                >
                  Admission 2025
                </Link>
