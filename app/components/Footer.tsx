          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link
                  href="/presentation"
                  className="group flex items-center text-blue-200 hover:text-white transition-all duration-300"
                >
              ...
              <li>
                <Link
                  href="/admission"
                  className="group flex items-center text-cyan-300 hover:text-cyan-100 transition-all duration-300 font-semibold"
                >
                  <ArrowRight className="w-4 h-4 mr-2 transform group-hover:translate-x-1 transition-transform" />
                  <span>Admission</span>
                </Link>
