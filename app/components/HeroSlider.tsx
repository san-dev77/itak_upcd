...
import { ChevronLeft, ChevronRight, GraduationCap, Users, Globe, Play, ArrowRight, Star } from "lucide-react";
...
const slides = [
    {
        ...
        description: "Rejoignez une université moderne qui forme les leaders de demain grâce à un enseignement d'excellence, des infrastructures de pointe et un accompagnement personnalisé vers la réussite.",
        icon: GraduationCap,
    ...
    },
    {
        ...
        description: "Participez à la recherche scientifique de pointe avec nos laboratoires modernes, nos partenariats internationaux et nos programmes d'innovation technologique pour l'Afrique.",
        icon: Users,
    ...
    },
    {
        ...
        description: "Bénéficiez de nos partenariats privilégiés avec l'Espagne (CEDIFA), d'opportunités de stages à Séville et d'échanges académiques pour une formation internationale.",
        icon: Globe,
                                ...
                                <div className="grid lg:grid-cols-2 gap-12 items-center">
                                    ...
                                    <div className="text-white space-y-6">
                                        ...
                                        <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight animate-fade-in-up animation-delay-200">
                                            <span className="block text-white">{slide.title.split(' ')[0]}</span>
                                            <span className="block bg-gradient-to-r from-blue-400 to-cyan-400 bg-clip-text text-transparent">{slide.title.split(' ').slice(1).join(' ')}</span>
                                        </h1>
                                        ...
                                        <div className="flex items-center space-x-6 pt-6 animate-fade-in-up animation-delay-1000">
                                            <div className="flex items-center space-x-1">
                                                ...
                                                <span className="text-sm text-gray-300 ml-2">Excellence reconnue</span>
                                            </div>
                                    ...
                                    <div className="hidden lg:block space-y-4 animate-fade-in-up animation-delay-1200">
                                        <div className="group bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-white/30 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                                            ...
                                            <div className="text-white font-bold text-lg">Facultés d'Excellence</div>
                                            <div className="text-blue-200 text-sm font-medium">FDECO & FAST</div>
                                        </div>
                                        <div className="group bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-white/30 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                                            <div className="text-4xl font-bold text-indigo-400 mb-2 group-hover:scale-110 transition-transform">20+</div>
                                            <div className="text-white font-bold text-lg">Filières Spécialisées</div>
                                            <div className="text-indigo-200 text-sm font-medium">DUT, Licence, Master</div>
                                        </div>
                                        <div className="group bg-white/15 backdrop-blur-md rounded-2xl p-6 border border-white/30 hover:bg-white/20 transition-all duration-300 hover:scale-105 hover:shadow-2xl">
                                            <div className="text-4xl font-bold text-cyan-400 mb-2 group-hover:scale-110 transition-transform">85%</div>
                                            <div className="text-white font-bold text-lg">Taux d'Insertion</div>
                                            <div className="text-cyan-200 text-sm font-medium">Emploi garanti</div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div className="container mx-auto px-4">
                                        <div className="grid grid-cols-3 gap-4">
                                            <div className="bg-white/15 backdrop-blur-md rounded-xl p-4 text-center border border-white/30">
                                                ...
                                                <div className="text-white text-sm font-semibold">Facultés</div>
                                            </div>
                                            <div className="bg-white/15 backdrop-blur-md rounded-xl p-4 text-center border border-white/30">
                                                <div className="text-2xl font-bold text-indigo-400 mb-1">20+</div>
                                                <div className="text-white text-sm font-semibold">Filières</div>
                                            </div>
                                            <div className="bg-white/15 backdrop-blur-md rounded-xl p-4 text-center border border-white/30">
                                                <div className="text-2xl font-bold text-cyan-400 mb-1">85%</div>
                                                <div className="text-white text-sm font-semibold">Insertion</div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
