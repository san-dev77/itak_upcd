...
import {
  Globe, Handshake, Award, Users, Target, CheckCircle, ArrowRight,
  Star, Trophy, Heart, Zap, Building, Plane, GraduationCap,
  BookOpen, Lightbulb, MapPin, Calendar, Clock, Mail, Briefcase
} from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white">
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center w-full">
            ...
            <div className="space-y-8">
              ...
              <p className="text-xl md:text-2xl text-gray-300 leading-relaxed max-w-2xl">
                Des collaborations stratégiques nationales et internationales pour offrir
                à nos étudiants les meilleures opportunités de formation et d'insertion professionnelle.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-8 leading-tight">
              Une Ouverture sur le <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Monde</span>
            </h2>
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              L'UPCD a développé un réseau de partenariats stratégiques au niveau national et international
              pour offrir à ses étudiants les meilleures opportunités de formation et d'insertion professionnelle.
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-center mb-4 text-gray-900">Partenariats Nationaux</h3>
                  <p className="text-gray-600 text-center leading-relaxed mb-6">
                    Collaborations avec les institutions maliennes pour le soutien financier et l'accompagnement des étudiants
                  </p>

                  <div className="space-y-3">
                    <div className="flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-blue-600 mr-2" />
                      <span className="text-gray-600 text-sm">FAFPA - Formation professionnelle</span>
                    </div>
                    <div className="flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-blue-600 mr-2" />
                      <span className="text-gray-600 text-sm">DSSA - Bourses militaires</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-center mb-4 text-gray-900">Partenariats Internationaux</h3>
                  <p className="text-gray-600 text-center leading-relaxed mb-6">
                    Ouverture sur l'Europe avec des opportunités de stages et d'échanges académiques enrichissants
                  </p>

                  <div className="space-y-3">
                    <div className="flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-blue-600 mr-2" />
                      <span className="text-gray-600 text-sm">CEDIFA - Stages en Espagne</span>
                    </div>
                    <div className="flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-blue-600 mr-2" />
                      <span className="text-gray-600 text-sm">Échanges académiques</span>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white rounded-3xl p-8 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-2xl font-bold text-center mb-4 text-gray-900">Impact sur l'Insertion</h3>
                  <p className="text-gray-600 text-center leading-relaxed mb-6">
                    95% de nos diplômés trouvent un emploi grâce à notre réseau de partenaires et aux opportunités offertes
                  </p>

                  <div className="space-y-3">
                    <div className="flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-blue-600 mr-2" />
                      <span className="text-gray-600 text-sm">Réseau professionnel élargi</span>
                    </div>
                    <div className="flex items-center justify-center">
                      <CheckCircle className="w-5 h-5 text-blue-600 mr-2" />
                      <span className="text-gray-600 text-sm">Expérience internationale</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-gradient-to-r from-blue-900 to-indigo-900 rounded-3xl p-12 text-white">
              <div className="text-center mb-12">
                <h3 className="text-3xl font-bold mb-4">Notre Réseau en Chiffres</h3>
                <p className="text-xl text-blue-200">Des partenariats qui font la différence</p>
              </div>

              <div className="grid md:grid-cols-4 gap-8">
                <div className="text-center">
                  <div className="text-4xl font-bold text-blue-400 mb-2">5+</div>
                  <div className="text-white font-semibold">Partenaires Actifs</div>
                  <div className="text-blue-200 text-sm mt-1">Nationaux & Internationaux</div>
                </div>

                <div className="text-center">
                  <div className="text-4xl font-bold text-blue-300 mb-2">3</div>
                  <div className="text-white font-semibold">Pays</div>
                  <div className="text-blue-200 text-sm mt-1">Mali, Espagne, Europe</div>
                </div>

                <div className="text-center">
                  <div className="text-4xl font-bold text-blue-500 mb-2">100+</div>
                  <div className="text-white font-semibold">Opportunités</div>
                  <div className="text-blue-200 text-sm mt-1">Stages & échanges annuels</div>
                </div>
      ...
      <section className="py-32 bg-gradient-to-br from-blue-50 to-indigo-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <h2 className="text-5xl md:text-6xl font-bold text-gray-900 mb-8 leading-tight">
              Partenariats <span className="bg-gradient-to-r from-blue-600 to-blue-800 bg-clip-text text-transparent">Nationaux</span>
            </h2>
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Des collaborations stratégiques avec les institutions maliennes pour soutenir financièrement nos étudiants
            </p>
          </div>
          ...
          <div className="max-w-7xl mx-auto">
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-10 relative z-10">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200 text-lg">Fonds d'Appui à la Formation Professionnelle et à l'Apprentissage</p>
                    </div>
                  </div>
                </div>

                <div className="p-10 relative z-10">
                  <h4 className="text-2xl font-bold mb-6 text-gray-900">Avantages du Partenariat</h4>
                  <div className="space-y-4 mb-8">
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Prise en charge totale ou partielle des frais de formation pour les professionnels en activité</span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Formations continues adaptées aux besoins évolutifs du marché du travail</span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Perfectionnement des compétences professionnelles et techniques</span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Accompagnement personnalisé dans la reconversion professionnelle</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200">
                    <div className="flex items-start">
                      ...
                      <p className="text-blue-800 font-medium leading-relaxed">
                        Ce partenariat stratégique permet aux professionnels en activité de bénéficier d'une formation
                        de qualité supérieure avec un soutien financier adapté à leur situation.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-10 relative z-10">
                  <div className="flex items-center mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-blue-200 text-lg">Direction du Service Social des Armées</p>
                    </div>
                  </div>
                </div>

                <div className="p-10 relative z-10">
                  <h4 className="text-2xl font-bold mb-6 text-gray-900">Bourses et Aides Financières</h4>
                  <div className="space-y-4 mb-8">
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Demi-bourses accordées aux enfants de militaires selon les critères</span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Bourses entières disponibles selon l'éligibilité et les besoins</span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Accompagnement social complet des familles militaires</span>
                    </div>
                    <div className="flex items-start">
                      <CheckCircle className="w-6 h-6 text-blue-600 mr-4 mt-1 flex-shrink-0" />
                      <span className="text-gray-700 leading-relaxed">Facilités de paiement adaptées aux situations familiales</span>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-r from-blue-50 to-blue-100 p-6 rounded-2xl border border-blue-200">
                    <div className="flex items-start">
                      ...
                      <p className="text-blue-800 font-medium leading-relaxed">
                        Un partenariat privilégié qui témoigne de notre engagement profond envers
                        les familles au service de la nation malienne.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="bg-gradient-to-r from-blue-900 to-blue-800 rounded-3xl p-12 text-white">
              <div className="text-center mb-12">
                <h3 className="text-3xl font-bold mb-4">Impact des Partenariats Nationaux</h3>
                <p className="text-xl text-blue-200">Un soutien concret pour nos étudiants maliens</p>
              </div>
              ...
              <div className="grid md:grid-cols-4 gap-8">
                <div className="text-center">
                  ...
                  <div className="text-white font-semibold">Étudiants Aidés</div>
                  <div className="text-blue-200 text-sm mt-1">Bénéficient d'un soutien</div>
                </div>

                <div className="text-center">
                  <div className="text-4xl font-bold text-blue-300 mb-2">2</div>
                  <div className="text-white font-semibold">Partenaires Clés</div>
                ...
                <div className="text-center">
                  ...
                  <div className="text-blue-200 text-sm mt-1">Processus d'attribution</div>
                </div>

                <div className="text-center">
                  <div className="text-4xl font-bold text-blue-600 mb-2">0€</div>
                  <div className="text-white font-semibold">Frais Dossier</div>
                  <div className="text-blue-200 text-sm mt-1">Candidature gratuite</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-800 mb-4">Partenariats Internationaux</h2>
            <div className="w-24 h-1 bg-blue-500 mx-auto mb-6"></div>
            <p className="text-xl text-gray-600">
              Une ouverture sur l'Europe pour enrichir votre parcours académique
            </p>
          </div>
              ...
              <div className="p-8 lg:p-12">
                <div className="flex flex-col lg:flex-row items-center mb-8">
                  ...
                  <div className="lg:w-2/3 text-center lg:text-left">
                    <h3 className="text-3xl font-bold text-gray-800 mb-2">CEDIFA</h3>
                    <p className="text-xl text-blue-600 font-semibold mb-4">Centre Espagnol - Séville</p>
                    <p className="text-gray-700 text-lg">
                      Un partenariat stratégique qui ouvre les portes de l'Europe à nos étudiants et notre personnel
                    </p>
                  </div>
                </div>
                ...
                <div className="grid md:grid-cols-2 gap-8">
                  <div>
                    <h4 className="text-xl font-semibold mb-4 text-gray-800">Pour les Étudiants</h4>
                  ...
                  <div>
                    <h4 className="text-xl font-semibold mb-4 text-gray-800">Pour le Personnel</h4>
                    <ul className="space-y-3 text-gray-700">
                      <li className="flex items-start">
                        <Users className="w-5 h-5 text-blue-500 mr-3 mt-1" />
                ...
                <div className="mt-8 p-6 bg-white rounded-lg shadow-inner">
                  <h5 className="text-lg font-semibold mb-3 text-gray-800">Impact du Partenariat</h5>
                  <p className="text-gray-700">
                    Cette collaboration avec CEDIFA permet à l'UPCD d'offrir une dimension internationale
                    à ses formations, préparant ainsi nos diplômés à évoluer dans un monde globalisé.
                    Les stages en Espagne constituent une opportunité unique d'acquérir une expérience
                    européenne valorisante sur le marché du travail.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section className="py-20 bg-blue-900 text-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4">Avantages pour nos Étudiants</h2>
            <div className="w-24 h-1 bg-blue-500 mx-auto mb-6"></div>
            <p className="text-xl text-blue-200 max-w-3xl mx-auto">
              Nos partenariats offrent des opportunités uniques pour enrichir votre parcours
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3">Ouverture Internationale</h3>
              <p className="text-purple-200">
            ...
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold mb-3">Insertion Professionnelle</h3>
      ...
      <section className="py-20 bg-gradient-to-r from-blue-500 to-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-6">Profitez de nos Partenariats</h2>
