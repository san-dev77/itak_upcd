...
export default function VieEtudiante() {
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-[500px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-screen bg-gradient-to-br from-slate-900 via-green-900 to-emerald-900 text-white overflow-hidden">
        {/* Background decorative elements */}
        <div className="absolute inset-0 opacity-10">
          <div className="absolute top-20 left-20 w-48 h-48 sm:w-64 sm:h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 bg-green-500 rounded-full blur-3xl animate-pulse"></div>
        ...
        <div className="relative container mx-auto px-4 sm:px-6 min-h-[500px] sm:min-h-[600px] md:min-h-[700px] lg:min-h-screen flex items-center py-12 sm:py-16 md:py-20">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 md:gap-16 items-center w-full">
            ...
            <div className="space-y-4 sm:space-y-6 md:space-y-8">
              <div className="inline-flex items-center bg-white/10 backdrop-blur-sm text-green-300 rounded-full px-4 py-2 sm:px-6 sm:py-3 text-xs sm:text-sm font-semibold border border-white/20">
              ...
              <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-2xl text-gray-300 leading-relaxed max-w-2xl">
                Découvrez la richesse de la vie universitaire à l&apos;UPCD :
                communauté dynamique, activités variées et accompagnement
                personnalisé pour votre épanouissement.
              </p>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Un environnement dynamique et enrichissant pour
              l&apos;épanouissement personnel et académique de tous nos
              étudiants
            </p>
          </div>
            ...
            <div className="grid lg:grid-cols-3 gap-8 mb-16">
              ...
              <div className="group bg-white rounded-3xl p-10 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-700 text-center leading-relaxed mb-6">
                    Installations modernes au centre-ville de Kati avec des
                    équipements de pointe pour l&apos;apprentissage et
                    l&apos;innovation
                  </p>
              ...
              <div className="group bg-white rounded-3xl p-10 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-700 text-center leading-relaxed mb-6">
                    Une communauté diverse et dynamique favorisant les échanges
                    interculturels et l&apos;entraide mutuelle
                  </p>
              ...
              <div className="group bg-white rounded-3xl p-10 shadow-xl border border-gray-100 hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <p className="text-gray-700 text-center leading-relaxed mb-6">
                    Suivi personnalisé et accompagnement dans le parcours
                    académique et professionnel de chaque étudiant
                  </p>
      ...
      <section className="py-32 bg-gradient-to-br from-gray-50 to-blue-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Découvrez les moments forts de la vie étudiante à travers notre
              galerie dynamique et inspirante
            </p>
          </div>
              ...
              {[
                {
                  ...
                  description:
                    "Événements et activités organisés par les étudiants",
                  icon: PartyPopper,
                  color: "blue",
                },
                {
                  ...
                  description:
                    "Conférences, séminaires et événements académiques",
                  icon: Calendar,
                  color: "green",
                },
                {
                  ...
                  description:
                    "Collaboration et travail en équipe entre étudiants",
                  icon: Users,
                  color: "purple",
                },
                {
                ...
                },
                {
                  ...
                  title: "Soutenances",
                  description:
                    "Présentations de projets et soutenances académiques",
                  icon: GraduationCap,
                  color: "red",
                },
                {
                  ...
                  description:
                    "Pauses café et moments de détente entre étudiants",
                  icon: Coffee,
                  color: "teal",
                },
              ].map((item, index) => {
                ...
                return (
                  <div
                    key={index}
                    className="group overflow-hidden relative  rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2"
                  >
      ...
      <section className="py-32 bg-gradient-to-b from-white to-gray-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-700 max-w-4xl mx-auto leading-relaxed">
              Des services complets et modernes pour accompagner votre réussite
              académique et votre épanouissement personnel
            </p>
          </div>
              ...
              {[
                {
                  ...
                  title: "Bibliothèque",
                  description:
                    "Ressources documentaires numériques et physiques avec espaces d&apos;étude modernes",
                  color: "blue",
                  features: [
                    "10,000+ ouvrages",
                    "Accès numérique",
                ...
                },
                {
                  ...
                  title: "Laboratoires",
                  description:
                    "Équipements informatiques et scientifiques de dernière génération",
                  color: "green",
                  features: [
                ...
                },
                {
                  ...
                  title: "Orientation",
                  description:
                    "Conseil personnalisé et accompagnement dans votre parcours académique",
                  color: "orange",
                  features: [
                    "Conseillers dédiés",
                    "Suivi individuel",
                ...
                },
                {
                  ...
                  title: "Stages",
                  description:
                    "Opportunités de stages nationaux et internationaux avec nos partenaires",
                  color: "purple",
                  features: [
                    "Réseau partenaires",
                    "Stages à l&apos;étranger",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center mb-20">
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              L&apos;UPCD s&apos;engage à rendre l&apos;éducation accessible
              grâce à ses partenariats stratégiques et programmes d&apos;aide
            </p>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-10 border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-3xl font-bold mb-4 text-orange-400 text-center">
                    FAFPA
                  </h3>
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6">
                    Possibilité de prise en charge des frais de formation pour
                    les professionnels souhaitant se perfectionner ou se
                    reconvertir dans leur carrière.
                  </p>
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-3xl p-10 border border-white/20 hover:bg-white/15 transition-all duration-300 transform hover:scale-105 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <h3 className="text-3xl font-bold mb-4 text-blue-400 text-center">
                    DSSA
                  </h3>
                  ...
                  <p className="text-gray-300 leading-relaxed mb-6">
                    L&apos;UPCD octroie des demi-bourses et bourses entières aux
                    enfants des militaires dans le cadre de ce partenariat
                    privilégié et stratégique.
                  </p>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-center">
                      ...
                      <span className="text-gray-300">
                        Bourses entières disponibles
                      </span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-blue-400 mr-3" />
                      <span className="text-gray-300">
                        Demi-bourses accordées
                      </span>
                    </div>
                    <div className="flex items-center">
                      <CheckCircle className="w-5 h-5 text-blue-400 mr-3" />
            ...
            <div className="bg-white/5 backdrop-blur-sm rounded-3xl p-12 border border-white/10">
              <div className="text-center mb-12">
                <h3 className="text-3xl font-bold mb-4">
                  Aide Financière en Chiffres
                </h3>
                <p className="text-xl text-gray-300">
                  Un soutien concret pour tous nos étudiants
                </p>
              </div>
